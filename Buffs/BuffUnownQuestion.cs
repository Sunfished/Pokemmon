...
{
	public class BuffUnownQuestion : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownQuestion").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownQuestion = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownQuestion || modPlayer.pokemonAmount > 1) {
