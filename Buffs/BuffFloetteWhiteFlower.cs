...
namespace Pokemmon.Buffs
{
	public class BuffFloetteWhiteFlower : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("FloetteWhiteFlower").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedFloetteWhiteFlower = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedFloetteWhiteFlower || modPlayer.pokemonAmount > 1) {
