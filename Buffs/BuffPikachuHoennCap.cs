...
namespace Pokemmon.Buffs
{
	public class BuffPikachuHoennCap : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("PikachuHoennCap").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedPikachuHoennCap = true;
				modPlayer.buffElectricType = true;
			}
			if (!modPlayer.summonedPikachuHoennCap || modPlayer.pokemonAmount > 1) {
