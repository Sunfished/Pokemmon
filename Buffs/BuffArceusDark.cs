...
{
	public class BuffArceusDark : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ArceusDark").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArceusDark = true;
				modPlayer.buffDarkType = true;
			}
			if (!modPlayer.summonedArceusDark || modPlayer.pokemonAmount > 1) {
