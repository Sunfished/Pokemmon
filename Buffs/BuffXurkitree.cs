...
namespace Pokemmon.Buffs
{
	public class BuffXurkitree : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Xurkitree").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedXurkitree = true;
				modPlayer.buffElectricType = true;
			}
			if (!modPlayer.summonedXurkitree || modPlayer.pokemonAmount > 1) {
