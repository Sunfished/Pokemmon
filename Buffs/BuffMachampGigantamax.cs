...
namespace Pokemmon.Buffs
{
	public class BuffMachampGigantamax : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("MachampGigantamax").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedMachampGigantamax = true;
				modPlayer.buffFightingType = true;
			}
			if (!modPlayer.summonedMachampGigantamax || modPlayer.pokemonAmount > 1) {
