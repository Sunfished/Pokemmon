...
{
	public class BuffShellosWestSea : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ShellosWestSea").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedShellosWestSea = true;
				modPlayer.buffWaterType = true;
			}
			if (!modPlayer.summonedShellosWestSea || modPlayer.pokemonAmount > 1) {
