...
namespace Pokemmon.Buffs
{
	public class BuffCramorant : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Cramorant").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedCramorant = true;
				modPlayer.buffFlyingType = true;
				modPlayer.buffWaterType = true;
			}
			if (!modPlayer.summonedCramorant || modPlayer.pokemonAmount > 1) {
