...
namespace Pokemmon.Buffs
{
	public class BuffCorviknight : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Corviknight").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedCorviknight = true;
				modPlayer.buffFlyingType = true;
				modPlayer.buffSteelType = true;
			}
			if (!modPlayer.summonedCorviknight || modPlayer.pokemonAmount > 1) {
