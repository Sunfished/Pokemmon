...
namespace Pokemmon.Buffs
{
	public class BuffPerrserker : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Perrserker").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedPerrserker = true;
				modPlayer.buffSteelType = true;
			}
			if (!modPlayer.summonedPerrserker || modPlayer.pokemonAmount > 1) {
