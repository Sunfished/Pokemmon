...
{
	public class BuffKangaskhan : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Kangaskhan").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedKangaskhan = true;
				modPlayer.buffNormalType = true;
			}
			if (!modPlayer.summonedKangaskhan || modPlayer.pokemonAmount > 1) {
