...
{
	public class BuffUnownU : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownU").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownU = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownU || modPlayer.pokemonAmount > 1) {
