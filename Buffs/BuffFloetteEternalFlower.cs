...
namespace Pokemmon.Buffs
{
	public class BuffFloetteEternalFlower : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("FloetteEternalFlower").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedFloetteEternalFlower = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedFloetteEternalFlower || modPlayer.pokemonAmount > 1) {
