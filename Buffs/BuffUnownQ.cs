...
{
	public class BuffUnownQ : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownQ").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownQ = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownQ || modPlayer.pokemonAmount > 1) {
