...
namespace Pokemmon.Buffs
{
	public class BuffDuraludonGigantamax : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("DuraludonGigantamax").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedDuraludonGigantamax = true;
				modPlayer.buffSteelType = true;
			}
			if (!modPlayer.summonedDuraludonGigantamax || modPlayer.pokemonAmount > 1) {
