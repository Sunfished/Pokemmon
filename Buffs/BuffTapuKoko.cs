...
namespace Pokemmon.Buffs
{
	public class BuffTapuKoko : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("TapuKoko").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedTapuKoko = true;
				modPlayer.buffElectricType = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedTapuKoko || modPlayer.pokemonAmount > 1) {
