...
{
	public class BuffUnownL : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownL").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownL = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownL || modPlayer.pokemonAmount > 1) {
