...
{
	public class BuffUnownM : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownM").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownM = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownM || modPlayer.pokemonAmount > 1) {
