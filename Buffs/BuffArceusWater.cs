...
{
	public class BuffArceusWater : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ArceusWater").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArceusWater = true;
				modPlayer.buffWaterType = true;
			}
			if (!modPlayer.summonedArceusWater || modPlayer.pokemonAmount > 1) {
