...
{
	public class BuffArceusGrass : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ArceusGrass").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArceusGrass = true;
				modPlayer.buffGrassType = true;
			}
			if (!modPlayer.summonedArceusGrass || modPlayer.pokemonAmount > 1) {
