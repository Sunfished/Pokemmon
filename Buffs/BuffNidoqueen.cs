...
namespace Pokemmon.Buffs
{
	public class BuffNidoqueen : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Nidoqueen").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedNidoqueen = true;
				modPlayer.buffPoisonType = true;
				modPlayer.buffGroundType = true;
			}
			if (!modPlayer.summonedNidoqueen || modPlayer.pokemonAmount > 1) {
