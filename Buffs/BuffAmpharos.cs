...
namespace Pokemmon.Buffs
{
	public class BuffAmpharos : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Ampharos").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedAmpharos = true;
				modPlayer.buffElectricType = true;
			}
			if (!modPlayer.summonedAmpharos || modPlayer.pokemonAmount > 1) {
