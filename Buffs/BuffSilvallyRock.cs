...
{
	public class BuffSilvallyRock : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("SilvallyRock").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSilvallyRock = true;
				modPlayer.buffRockType = true;
			}
			if (!modPlayer.summonedSilvallyRock || modPlayer.pokemonAmount > 1) {
