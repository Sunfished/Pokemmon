...
namespace Pokemmon.Buffs
{
	public class BuffAlcremieLemonCream : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("AlcremieLemonCream").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedAlcremieLemonCream = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedAlcremieLemonCream || modPlayer.pokemonAmount > 1) {
