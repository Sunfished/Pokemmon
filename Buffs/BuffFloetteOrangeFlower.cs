...
namespace Pokemmon.Buffs
{
	public class BuffFloetteOrangeFlower : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("FloetteOrangeFlower").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedFloetteOrangeFlower = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedFloetteOrangeFlower || modPlayer.pokemonAmount > 1) {
