...
namespace Pokemmon.Buffs
{
	public class BuffPikachuUnovaCap : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("PikachuUnovaCap").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedPikachuUnovaCap = true;
				modPlayer.buffElectricType = true;
			}
			if (!modPlayer.summonedPikachuUnovaCap || modPlayer.pokemonAmount > 1) {
