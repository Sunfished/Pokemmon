...
{
	public class BuffSilvallyDragon : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("SilvallyDragon").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSilvallyDragon = true;
				modPlayer.buffDragonType = true;
			}
			if (!modPlayer.summonedSilvallyDragon || modPlayer.pokemonAmount > 1) {
