...
{
	public class BuffArceusGround : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ArceusGround").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArceusGround = true;
				modPlayer.buffGroundType = true;
			}
			if (!modPlayer.summonedArceusGround || modPlayer.pokemonAmount > 1) {
