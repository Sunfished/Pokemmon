...
{
	public class BuffUnownY : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownY").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownY = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownY || modPlayer.pokemonAmount > 1) {
