...
namespace Pokemmon.Buffs
{
	public class BuffJellicentM : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("JellicentM").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedJellicentM = true;
				modPlayer.buffWaterType = true;
				modPlayer.buffGhostType = true;
			}
			if (!modPlayer.summonedJellicentM || modPlayer.pokemonAmount > 1) {
