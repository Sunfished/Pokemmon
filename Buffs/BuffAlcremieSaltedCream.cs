...
namespace Pokemmon.Buffs
{
	public class BuffAlcremieSaltedCream : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("AlcremieSaltedCream").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedAlcremieSaltedCream = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedAlcremieSaltedCream || modPlayer.pokemonAmount > 1) {
