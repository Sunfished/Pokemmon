...
namespace Pokemmon.Buffs
{
	public class BuffFrillishM : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("FrillishM").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedFrillishM = true;
				modPlayer.buffWaterType = true;
				modPlayer.buffGhostType = true;
			}
			if (!modPlayer.summonedFrillishM || modPlayer.pokemonAmount > 1) {
