...
namespace Pokemmon.Buffs
{
	public class BuffGrimmsnarl : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Grimmsnarl").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedGrimmsnarl = true;
				modPlayer.buffDarkType = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedGrimmsnarl || modPlayer.pokemonAmount > 1) {
