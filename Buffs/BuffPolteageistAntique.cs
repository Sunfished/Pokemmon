...
namespace Pokemmon.Buffs
{
	public class BuffPolteageistAntique : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("PolteageistAntique").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedPolteageistAntique = true;
				modPlayer.buffGhostType = true;
			}
			if (!modPlayer.summonedPolteageistAntique || modPlayer.pokemonAmount > 1) {
