...
namespace Pokemmon.Buffs
{
	public class BuffPikachuPartnerCap : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("PikachuPartnerCap").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedPikachuPartnerCap = true;
				modPlayer.buffElectricType = true;
			}
			if (!modPlayer.summonedPikachuPartnerCap || modPlayer.pokemonAmount > 1) {
