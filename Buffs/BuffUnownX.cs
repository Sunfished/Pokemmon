...
{
	public class BuffUnownX : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownX").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownX = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownX || modPlayer.pokemonAmount > 1) {
