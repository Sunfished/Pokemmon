...
{
	public class BuffUnownV : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownV").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownV = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownV || modPlayer.pokemonAmount > 1) {
