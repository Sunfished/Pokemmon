...
{
	public class BuffUnownH : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownH").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownH = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownH || modPlayer.pokemonAmount > 1) {
