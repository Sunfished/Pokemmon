...
{
	public class BuffSilvallyGrass : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("SilvallyGrass").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSilvallyGrass = true;
				modPlayer.buffGrassType = true;
			}
			if (!modPlayer.summonedSilvallyGrass || modPlayer.pokemonAmount > 1) {
