...
namespace Pokemmon.Buffs
{
	public class BuffAlcremieRainbowCream : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("AlcremieRainbowCream").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedAlcremieRainbowCream = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedAlcremieRainbowCream || modPlayer.pokemonAmount > 1) {
