...
{
	public class BuffArceusDragon : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ArceusDragon").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArceusDragon = true;
				modPlayer.buffDragonType = true;
			}
			if (!modPlayer.summonedArceusDragon || modPlayer.pokemonAmount > 1) {
