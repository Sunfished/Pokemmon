...
{
	public class BuffSilvallyPoison : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("SilvallyPoison").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSilvallyPoison = true;
				modPlayer.buffPoisonType = true;
			}
			if (!modPlayer.summonedSilvallyPoison || modPlayer.pokemonAmount > 1) {
