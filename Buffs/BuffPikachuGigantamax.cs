...
namespace Pokemmon.Buffs
{
	public class BuffPikachuGigantamax : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("PikachuGigantamax").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedPikachuGigantamax = true;
				modPlayer.buffElectricType = true;
			}
			if (!modPlayer.summonedPikachuGigantamax || modPlayer.pokemonAmount > 1) {
