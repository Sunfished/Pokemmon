...
{
	public class BuffArceusElectric : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ArceusElectric").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArceusElectric = true;
				modPlayer.buffElectricType = true;
			}
			if (!modPlayer.summonedArceusElectric || modPlayer.pokemonAmount > 1) {
