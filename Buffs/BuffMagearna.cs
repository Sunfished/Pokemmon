...
{
	public class BuffMagearna : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Magearna").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedMagearna = true;
				modPlayer.buffSteelType = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedMagearna || modPlayer.pokemonAmount > 1) {
