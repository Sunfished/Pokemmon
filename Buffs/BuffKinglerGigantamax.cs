...
namespace Pokemmon.Buffs
{
	public class BuffKinglerGigantamax : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("KinglerGigantamax").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedKinglerGigantamax = true;
				modPlayer.buffWaterType = true;
			}
			if (!modPlayer.summonedKinglerGigantamax || modPlayer.pokemonAmount > 1) {
