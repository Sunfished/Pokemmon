...
namespace Pokemmon.Buffs
{
	public class BuffLarvesta : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Larvesta").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedLarvesta = true;
				modPlayer.buffBugType = true;
				modPlayer.buffFireType = true;
			}
			if (!modPlayer.summonedLarvesta || modPlayer.pokemonAmount > 1) {
