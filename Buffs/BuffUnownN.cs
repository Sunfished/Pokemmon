...
{
	public class BuffUnownN : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownN").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownN = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownN || modPlayer.pokemonAmount > 1) {
