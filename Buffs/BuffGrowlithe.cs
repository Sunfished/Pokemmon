...
namespace Pokemmon.Buffs
{
	public class BuffGrowlithe : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Growlithe").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedGrowlithe = true;
				modPlayer.buffFireType = true;
			}
			if (!modPlayer.summonedGrowlithe || modPlayer.pokemonAmount > 1) {
