...
namespace Pokemmon.Buffs
{
	public class BuffPikachuLibre : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("PikachuLibre").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedPikachuLibre = true;
				modPlayer.buffElectricType = true;
			}
			if (!modPlayer.summonedPikachuLibre || modPlayer.pokemonAmount > 1) {
