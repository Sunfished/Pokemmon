...
{
	public class BuffArceusRock : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ArceusRock").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArceusRock = true;
				modPlayer.buffRockType = true;
			}
			if (!modPlayer.summonedArceusRock || modPlayer.pokemonAmount > 1) {
