...
namespace Pokemmon.Buffs
{
	public class BuffIndeedeeM : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("IndeedeeM").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedIndeedeeM = true;
				modPlayer.buffPsychicType = true;
				modPlayer.buffNormalType = true;
			}
			if (!modPlayer.summonedIndeedeeM || modPlayer.pokemonAmount > 1) {
