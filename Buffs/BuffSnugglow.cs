...
namespace Pokemmon.Buffs
{
	public class BuffSnugglow : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Snugglow").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSnugglow = true;
				modPlayer.buffElectricType = true;
				modPlayer.buffPoisonType = true;
			}
			if (!modPlayer.summonedSnugglow || modPlayer.pokemonAmount > 1) {
