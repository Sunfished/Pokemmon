...
namespace Pokemmon.Buffs
{
	public class BuffTentacool : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Tentacool").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedTentacool = true;
				modPlayer.buffWaterType = true;
				modPlayer.buffPoisonType = true;
			}
			if (!modPlayer.summonedTentacool || modPlayer.pokemonAmount > 1) {
