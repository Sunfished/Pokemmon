...
{
	public class BuffUnownZ : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownZ").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownZ = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownZ || modPlayer.pokemonAmount > 1) {
