...
namespace Pokemmon.Buffs
{
	public class BuffMeowthGigantamax : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("MeowthGigantamax").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedMeowthGigantamax = true;
				modPlayer.buffNormalType = true;
			}
			if (!modPlayer.summonedMeowthGigantamax || modPlayer.pokemonAmount > 1) {
