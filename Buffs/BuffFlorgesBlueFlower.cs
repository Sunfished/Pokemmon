...
namespace Pokemmon.Buffs
{
	public class BuffFlorgesBlueFlower : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("FlorgesBlueFlower").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedFlorgesBlueFlower = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedFlorgesBlueFlower || modPlayer.pokemonAmount > 1) {
