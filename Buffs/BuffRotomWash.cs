...
namespace Pokemmon.Buffs
{
	public class BuffRotomWash : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("RotomWash").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedRotomWash = true;
				modPlayer.buffElectricType = true;
				modPlayer.buffWaterType = true;
			}
			if (!modPlayer.summonedRotomWash || modPlayer.pokemonAmount > 1) {
