...
{
	public class BuffUnownW : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownW").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownW = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownW || modPlayer.pokemonAmount > 1) {
