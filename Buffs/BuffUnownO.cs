...
{
	public class BuffUnownO : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownO").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownO = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownO || modPlayer.pokemonAmount > 1) {
