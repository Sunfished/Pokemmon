...
namespace Pokemmon.Buffs
{
	public class BuffBurmySandyCloak : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("BurmySandyCloak").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedBurmySandyCloak = true;
				modPlayer.buffBugType = true;
			}
			if (!modPlayer.summonedBurmySandyCloak || modPlayer.pokemonAmount > 1) {
