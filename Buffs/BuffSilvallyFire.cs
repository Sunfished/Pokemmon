...
namespace Pokemmon.Buffs
{
	public class BuffSilvallyFire : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("SilvallyFire").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSilvallyFire = true;
				modPlayer.buffFireType = true;
			}
			if (!modPlayer.summonedSilvallyFire || modPlayer.pokemonAmount > 1) {
