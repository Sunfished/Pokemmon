...
{
	public class BuffSilvallyPsychic : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("SilvallyPsychic").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSilvallyPsychic = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedSilvallyPsychic || modPlayer.pokemonAmount > 1) {
