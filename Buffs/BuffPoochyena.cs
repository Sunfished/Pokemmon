...
namespace Pokemmon.Buffs
{
	public class BuffPoochyena : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Poochyena").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedPoochyena = true;
				modPlayer.buffDarkType = true;
			}
			if (!modPlayer.summonedPoochyena || modPlayer.pokemonAmount > 1) {
