...
{
	public class BuffUnownA : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("UnownA").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedUnownA = true;
				modPlayer.buffPsychicType = true;
			}
			if (!modPlayer.summonedUnownA || modPlayer.pokemonAmount > 1) {
