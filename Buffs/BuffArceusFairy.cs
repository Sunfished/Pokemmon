...
{
	public class BuffArceusFairy : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ArceusFairy").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArceusFairy = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedArceusFairy || modPlayer.pokemonAmount > 1) {
