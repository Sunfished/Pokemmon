...
{
	public class BuffArceusGhost : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("ArceusGhost").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArceusGhost = true;
				modPlayer.buffGhostType = true;
			}
			if (!modPlayer.summonedArceusGhost || modPlayer.pokemonAmount > 1) {
