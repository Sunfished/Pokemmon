...
namespace Pokemmon.Buffs
{
	public class BuffAlcremieMatchaCream : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("AlcremieMatchaCream").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedAlcremieMatchaCream = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedAlcremieMatchaCream || modPlayer.pokemonAmount > 1) {
