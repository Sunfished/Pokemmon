...
namespace Pokemmon.Buffs
{
	public class BuffSilvallyFairy : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("SilvallyFairy").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSilvallyFairy = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedSilvallyFairy || modPlayer.pokemonAmount > 1) {
