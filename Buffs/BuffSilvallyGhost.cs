...
{
	public class BuffSilvallyGhost : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("SilvallyGhost").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSilvallyGhost = true;
				modPlayer.buffGhostType = true;
			}
			if (!modPlayer.summonedSilvallyGhost || modPlayer.pokemonAmount > 1) {
