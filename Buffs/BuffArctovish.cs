...
namespace Pokemmon.Buffs
{
	public class BuffArctovish : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Arctovish").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedArctovish = true;
				modPlayer.buffWaterType = true;
				modPlayer.buffIceType = true;
			}
			if (!modPlayer.summonedArctovish || modPlayer.pokemonAmount > 1) {
