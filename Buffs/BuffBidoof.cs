...
{
	public class BuffBidoof : ModBuff
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Go, Bidoof!");
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("Bidoof").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedBidoof = true;
				modPlayer.buffNormalType = true;
			}
			if (!modPlayer.summonedBidoof || modPlayer.pokemonAmount > 1) {
