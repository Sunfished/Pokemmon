...
namespace Pokemmon.Buffs
{
	public class BuffFlorgesOrangeFlower : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("FlorgesOrangeFlower").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedFlorgesOrangeFlower = true;
				modPlayer.buffFairyType = true;
			}
			if (!modPlayer.summonedFlorgesOrangeFlower || modPlayer.pokemonAmount > 1) {
