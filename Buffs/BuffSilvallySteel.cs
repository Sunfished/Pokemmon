...
{
	public class BuffSilvallySteel : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("SilvallySteel").Type] > 0 && modPlayer.pokemonAmount == 1) {
				player.buffTime[buffIndex] = 18000;
				modPlayer.summonedSilvallySteel = true;
				modPlayer.buffSteelType = true;
			}
			if (!modPlayer.summonedSilvallySteel || modPlayer.pokemonAmount > 1) {
