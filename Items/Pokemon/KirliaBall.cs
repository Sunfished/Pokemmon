...
namespace Pokemmon.Items.Pokemon
{
	...
	public class KirliaBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Kirlia");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffKirlia"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("GardevoirBall"));
			...
			recipe99.SetResult(mod.ItemType("RaltsBall"));
