...
namespace Pokemmon.Items.Pokemon
{
	...
	public class LinooneGalarBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("LinooneGalar");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffLinooneGalar"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("ObstagoonBall"));
