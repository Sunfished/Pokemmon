...
namespace Pokemmon.Items.Pokemon
{
	...
	public class FurfrouDandyTrimBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("FurfrouDandyTrim").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffFurfrouDandyTrim").Type; //The buff added to player after used the item
