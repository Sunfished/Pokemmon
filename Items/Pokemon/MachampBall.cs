...
namespace Pokemmon.Items.Pokemon
{
	...
	public class MachampBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Machamp");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffMachamp"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe99.SetResult(mod.ItemType("MachokeBall"));
