...
namespace Pokemmon.Items.Pokemon
{
	...
	public class BasculinBlueStripeBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("BasculinBlueStripe").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffBasculinBlueStripe").Type; //The buff added to player after used the item
