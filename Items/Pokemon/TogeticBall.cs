...
namespace Pokemmon.Items.Pokemon
{
	...
	public class TogeticBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Togetic").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffTogetic").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("TogekissBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("TogepiBall").Type);
