...
namespace Pokemmon.Items.Pokemon
{
	...
	public class AlcremieRubyCreamBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("AlcremieRubyCream").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffAlcremieRubyCream").Type; //The buff added to player after used the item
