...
namespace Pokemmon.Items.Pokemon
{
	...
	public class HaunterBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffHaunter"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("GengarBall"));
			...
			recipe99.SetResult(mod.ItemType("GastlyBall"));
