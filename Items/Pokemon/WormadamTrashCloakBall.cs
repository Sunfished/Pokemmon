...
namespace Pokemmon.Items.Pokemon
{
	...
	public class WormadamTrashCloakBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("WormadamTrashCloak");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffWormadamTrashCloak"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe99.SetResult(mod.ItemType("BurmyTrashCloakBall"));
