...
namespace Pokemmon.Items.Pokemon
{
	...
	public class WormadamTrashCloakBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("WormadamTrashCloak").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffWormadamTrashCloak").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("BurmyTrashCloakBall").Type);
