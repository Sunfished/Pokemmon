...
namespace Pokemmon.Items.Pokemon
{
	...
	public class FloetteBlueFlowerBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("FloetteBlueFlower").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffFloetteBlueFlower").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("FlorgesBlueFlowerBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("FlabebeBlueFlowerBall").Type);
