...
namespace Pokemmon.Items.Pokemon
{
	...
	public class NincadaBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Nincada");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffNincada"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("NinjaskBall"));
