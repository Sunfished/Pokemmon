...
namespace Pokemmon.Items.Pokemon
{
	...
	public class LombreBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Lombre");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffLombre"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("LudicoloBall"));
			...
			recipe99.SetResult(mod.ItemType("LotadBall"));
