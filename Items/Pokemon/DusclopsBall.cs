...
namespace Pokemmon.Items.Pokemon
{
	...
	public class DusclopsBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Dusclops");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffDusclops"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.AddIngredient(mod.GetItem("ItemReaperCloth"),1);
			recipe0.AddIngredient(mod.GetItem("ItemExpCandyL"),1);
			recipe0.SetResult(mod.ItemType("DusknoirBall"));
			...
			recipe99.SetResult(mod.ItemType("DuskullBall"));
