...
namespace Pokemmon.Items.Pokemon
{
	...
	public class BurmyTrashCloakBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("BurmyTrashCloak");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffBurmyTrashCloak"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("WormadamTrashCloakBall"));
