...
namespace Pokemmon.Items.Pokemon
{
	...
	public class VivillonTundraBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("VivillonTundra").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffVivillonTundra").Type; //The buff added to player after used the item
