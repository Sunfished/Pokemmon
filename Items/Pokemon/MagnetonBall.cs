...
namespace Pokemmon.Items.Pokemon
{
	...
	public class MagnetonBall : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Magneton's Pokeball");
			//Tooltip.SetDefault("");
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Magneton").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffMagneton").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("MagnezoneBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("MagnemiteBall").Type);
