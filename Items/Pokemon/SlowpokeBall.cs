...
namespace Pokemmon.Items.Pokemon
{
	...
	public class SlowpokeBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Slowpoke");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffSlowpoke"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("SlowbroBall"));
