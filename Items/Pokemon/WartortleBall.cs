...
namespace Pokemmon.Items.Pokemon
{
	...
	public class WartortleBall : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Wartortle's Pokeball");
			//Tooltip.SetDefault("");
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Wartortle").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffWartortle").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("BlastoiseBall").Type);
			recipe0.AddIngredient(this);
			recipe0.AddIngredient(Mod.Find<ModItem>("ItemExpCandyL").Type,36);
			recipe0.AddTile(Mod.Find<ModTile>("EvolutionMachine").Type);
			recipe0.Register();

			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("SquirtleBall").Type);
