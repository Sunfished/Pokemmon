...
namespace Pokemmon.Items.Pokemon
{
	...
	public class WartortleBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffWartortle"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("BlastoiseBall"));
			...
			recipe99.SetResult(mod.ItemType("SquirtleBall"));
