...
namespace Pokemmon.Items.Pokemon
{
	...
	public class NecrozmaDawnWingsBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("NecrozmaDawnWings").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffNecrozmaDawnWings").Type; //The buff added to player after used the item
