...
namespace Pokemmon.Items.Pokemon
{
	...
	public class PikachuBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Pikachu");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffPikachu"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("RaichuBall"));
			...
			recipe1.SetResult(mod.ItemType("RaichuAlolaBall"));
			...
			recipe99.SetResult(mod.ItemType("PichuBall"));
