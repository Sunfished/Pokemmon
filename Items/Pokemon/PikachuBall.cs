...
namespace Pokemmon.Items.Pokemon
{
	...
	public class PikachuBall : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Pikachu's Pokeball");
			//Tooltip.SetDefault("");
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Pikachu").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffPikachu").Type; //The buff added to player after used the item
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback) {
			...
			//modPlayer.summonedPikachu = true;
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("RaichuBall").Type);
