...
namespace Pokemmon.Items.Pokemon
{
	...
	public class LampentBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Lampent").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffLampent").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("ChandelureBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("LitwickBall").Type);
