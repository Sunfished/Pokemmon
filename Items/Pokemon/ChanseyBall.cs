...
namespace Pokemmon.Items.Pokemon
{
	...
	public class ChanseyBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffChansey"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("BlisseyBall"));
			...
			recipe99.SetResult(mod.ItemType("HappinyBall"));
