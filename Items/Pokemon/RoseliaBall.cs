...
namespace Pokemmon.Items.Pokemon
{
	...
	public class RoseliaBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Roselia");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffRoselia"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("RoseradeBall"));
			...
			recipe99.SetResult(mod.ItemType("BudewBall"));
