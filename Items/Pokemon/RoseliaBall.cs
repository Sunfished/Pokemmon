...
namespace Pokemmon.Items.Pokemon
{
	...
	public class RoseliaBall : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Roselia's Pokeball");
			//Tooltip.SetDefault("");
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Roselia").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffRoselia").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("RoseradeBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("BudewBall").Type);
