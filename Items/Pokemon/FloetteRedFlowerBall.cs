...
namespace Pokemmon.Items.Pokemon
{
	...
	public class FloetteRedFlowerBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("FloetteRedFlower").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffFloetteRedFlower").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("FlorgesRedFlowerBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("FlabebeRedFlowerBall").Type);
