...
namespace Pokemmon.Items.Pokemon
{
	...
	public class FloetteRedFlowerBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("FloetteRedFlower");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffFloetteRedFlower"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("FlorgesRedFlowerBall"));
			...
			recipe99.SetResult(mod.ItemType("FlabebeRedFlowerBall"));
