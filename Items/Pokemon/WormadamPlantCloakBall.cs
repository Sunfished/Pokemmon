...
namespace Pokemmon.Items.Pokemon
{
	...
	public class WormadamPlantCloakBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("WormadamPlantCloak").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffWormadamPlantCloak").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("BurmyPlantCloakBall").Type);
