...
namespace Pokemmon.Items.Pokemon
{
	...
	public class DuohmBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Duohm").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffDuohm").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("CyclohmBall").Type);
			recipe0.AddIngredient(this);
			recipe0.AddIngredient(Mod.Find<ModItem>("ItemExpCandyL").Type,1);
			recipe0.AddTile(Mod.Find<ModTile>("EvolutionMachine").Type);
			recipe0.Register();

			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("MonohmBall").Type);
