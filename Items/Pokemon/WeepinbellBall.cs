...
namespace Pokemmon.Items.Pokemon
{
	...
	public class WeepinbellBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Weepinbell");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffWeepinbell"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("VictreebelBall"));
			...
			recipe99.SetResult(mod.ItemType("BellsproutBall"));
