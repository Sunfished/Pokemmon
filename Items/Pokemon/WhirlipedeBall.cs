...
namespace Pokemmon.Items.Pokemon
{
	...
	public class WhirlipedeBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Whirlipede");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffWhirlipede"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("ScolipedeBall"));
			...
			recipe99.SetResult(mod.ItemType("VenipedeBall"));
