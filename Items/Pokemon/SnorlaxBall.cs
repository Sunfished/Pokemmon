...
namespace Pokemmon.Items.Pokemon
{
	...
	public class SnorlaxBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Snorlax").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffSnorlax").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("MunchlaxBall").Type);
