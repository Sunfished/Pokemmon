...
namespace Pokemmon.Items.Pokemon
{
	...
	public class IvysaurBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffIvysaur"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("VenusaurBall"));
			...
			recipe99.SetResult(mod.ItemType("BulbasaurBall"));
