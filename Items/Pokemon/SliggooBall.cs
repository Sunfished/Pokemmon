...
namespace Pokemmon.Items.Pokemon
{
	...
	public class SliggooBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Sliggoo");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffSliggoo"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("GoodraBall"));
			...
			recipe99.SetResult(mod.ItemType("GoomyBall"));
