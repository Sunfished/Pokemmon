...
namespace Pokemmon.Items.Pokemon
{
	...
	public class DoubladeBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Doublade");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffDoublade"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("AegislashShieldBall"));
			...
			recipe99.SetResult(mod.ItemType("HonedgeBall"));
