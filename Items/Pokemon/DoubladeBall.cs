...
namespace Pokemmon.Items.Pokemon
{
	...
	public class DoubladeBall : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Doublade's Pokeball");
			//Tooltip.SetDefault("");
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Doublade").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffDoublade").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("AegislashShieldBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("HonedgeBall").Type);
