...
namespace Pokemmon.Items.Pokemon
{
	...
	public class SeadraBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Seadra");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffSeadra"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.AddIngredient(mod.GetItem("ItemDragonScale"),1);
			recipe0.AddIngredient(mod.GetItem("ItemExpCandyL"),1);
			recipe0.SetResult(mod.ItemType("KingdraBall"));
			...
			recipe99.SetResult(mod.ItemType("HorseaBall"));
