...
namespace Pokemmon.Items.Pokemon
{
	...
	public class SharpedoBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Sharpedo").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffSharpedo").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("CarvanhaBall").Type);
