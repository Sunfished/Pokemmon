...
namespace Pokemmon.Items.Pokemon
{
	...
	public class SharpedoBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Sharpedo");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffSharpedo"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe99.SetResult(mod.ItemType("CarvanhaBall"));
