...
namespace Pokemmon.Items.Pokemon
{
	...
	public class VulpixAlolaBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("VulpixAlola").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffVulpixAlola").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("NinetalesAlolaBall").Type);
