...
namespace Pokemmon.Items.Pokemon
{
	...
	public class FurfrouLaReineTrimBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("FurfrouLaReineTrim").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffFurfrouLaReineTrim").Type; //The buff added to player after used the item
