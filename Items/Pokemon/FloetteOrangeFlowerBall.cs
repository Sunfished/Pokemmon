...
namespace Pokemmon.Items.Pokemon
{
	...
	public class FloetteOrangeFlowerBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("FloetteOrangeFlower").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffFloetteOrangeFlower").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("FlorgesOrangeFlowerBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("FlabebeOrangeFlowerBall").Type);
