...
namespace Pokemmon.Items.Pokemon
{
	...
	public class MimikyuBustedBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("MimikyuBusted").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffMimikyuBusted").Type; //The buff added to player after used the item
