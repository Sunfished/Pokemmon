...
namespace Pokemmon.Items.Pokemon
{
	...
	public class RhydonBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Rhydon");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffRhydon"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe99.SetResult(mod.ItemType("RhyhornBall"));
