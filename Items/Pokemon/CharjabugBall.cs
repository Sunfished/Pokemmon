...
namespace Pokemmon.Items.Pokemon
{
	...
	public class CharjabugBall : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Charjabug's Pokeball");
			//Tooltip.SetDefault("");
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Charjabug").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffCharjabug").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("VikavoltBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("GrubbinBall").Type);
