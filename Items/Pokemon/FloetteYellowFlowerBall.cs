...
namespace Pokemmon.Items.Pokemon
{
	...
	public class FloetteYellowFlowerBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("FloetteYellowFlower").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffFloetteYellowFlower").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("FlorgesYellowFlowerBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("FlabebeYellowFlowerBall").Type);
