...
namespace Pokemmon.Items.Pokemon
{
	...
	public class NinetalesAlolaBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("NinetalesAlola").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffNinetalesAlola").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("VulpixAlolaBall").Type);
