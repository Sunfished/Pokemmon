...
namespace Pokemmon.Items.Pokemon
{
	...
	public class NinetalesAlolaBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("NinetalesAlola");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffNinetalesAlola"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe99.SetResult(mod.ItemType("VulpixAlolaBall"));
