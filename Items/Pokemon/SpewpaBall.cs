...
namespace Pokemmon.Items.Pokemon
{
	...
	public class SpewpaBall : ModItem
	{
		...
		public override void AddRecipes()
		{
			...
			recipe0.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe1.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe2.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe3.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe4.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe5.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe6.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe7.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe8.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe9.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe10.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe11.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe12.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe13.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe14.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe15.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe16.AddIngredient(mod.GetItem("ItemRareCandy"),12);
			...
			recipe17.AddIngredient(mod.GetItem("ItemRareCandy"),12);
