...
namespace Pokemmon.Items.Pokemon
{
	...
	public class MusharnaBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Musharna");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffMusharna"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe99.SetResult(mod.ItemType("MunnaBall"));
