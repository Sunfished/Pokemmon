...
namespace Pokemmon.Items.Pokemon
{
	...
	public class VoodoomBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Voodoom").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffVoodoom").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("VoodollBall").Type);
