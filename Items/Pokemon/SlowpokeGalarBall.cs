...
namespace Pokemmon.Items.Pokemon
{
	...
	public class SlowpokeGalarBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("SlowpokeGalar").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffSlowpokeGalar").Type; //The buff added to player after used the item
