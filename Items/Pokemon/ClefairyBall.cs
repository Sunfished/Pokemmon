...
namespace Pokemmon.Items.Pokemon
{
	...
	public class ClefairyBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Clefairy");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffClefairy"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("ClefableBall"));
			...
			recipe99.SetResult(mod.ItemType("CleffaBall"));
