...
namespace Pokemmon.Items.Pokemon
{
	...
	public class GloomBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Gloom").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffGloom").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("VileplumeBall").Type);
			...
			Recipe recipe1 = Recipe.Create(Mod.Find<ModItem>("BellossomBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("OddishBall").Type);
