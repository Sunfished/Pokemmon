...
namespace Pokemmon.Items.Pokemon
{
	...
	public class BurmySandyCloakBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("BurmySandyCloak").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffBurmySandyCloak").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("WormadamSandyCloakBall").Type);
