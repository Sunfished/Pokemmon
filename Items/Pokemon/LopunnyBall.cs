...
namespace Pokemmon.Items.Pokemon
{
	...
	public class LopunnyBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Lopunny");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffLopunny"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe99.SetResult(mod.ItemType("BunearyBall"));
