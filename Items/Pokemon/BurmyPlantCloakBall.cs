...
namespace Pokemmon.Items.Pokemon
{
	...
	public class BurmyPlantCloakBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("BurmyPlantCloak").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffBurmyPlantCloak").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("WormadamPlantCloakBall").Type);
