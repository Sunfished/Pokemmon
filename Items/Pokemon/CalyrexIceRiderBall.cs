...
namespace Pokemmon.Items.Pokemon
{
	...
	public class CalyrexIceRiderBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("CalyrexIceRider").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffCalyrexIceRider").Type; //The buff added to player after used the item
