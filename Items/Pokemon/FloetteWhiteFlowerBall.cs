...
namespace Pokemmon.Items.Pokemon
{
	...
	public class FloetteWhiteFlowerBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("FloetteWhiteFlower");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffFloetteWhiteFlower"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("FlorgesWhiteFlowerBall"));
			...
			recipe99.SetResult(mod.ItemType("FlabebeWhiteFlowerBall"));
