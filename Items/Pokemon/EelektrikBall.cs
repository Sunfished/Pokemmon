...
namespace Pokemmon.Items.Pokemon
{
	...
	public class EelektrikBall : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Eelektrik's Pokeball");
			//Tooltip.SetDefault("");
		...
		public override void SetDefaults() {
			...
			Item.shoot = Mod.Find<ModProjectile>("Eelektrik").Type;
			Item.shootSpeed = 10f;
			Item.buffType = Mod.Find<ModBuff>("BuffEelektrik").Type; //The buff added to player after used the item
		...
		{
			Recipe recipe0 = Recipe.Create(Mod.Find<ModItem>("EelektrossBall").Type);
			...
			Recipe recipe99 = Recipe.Create(Mod.Find<ModItem>("TynamoBall").Type);
