...
namespace Pokemmon.Items.Pokemon
{
	...
	public class KubfuBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Kubfu");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffKubfu"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("UrshifuSingleStrikeStyleBall"));
			recipe0.AddTile(mod.TileType("EvolutionMachine"));
			recipe0.AddRecipe();

			ModRecipe recipe1 = new ModRecipe(mod);
			recipe1.AddIngredient(this);
			recipe1.AddIngredient(mod.GetItem("ItemWaterStone"),1);
			recipe1.AddIngredient(mod.GetItem("ItemExpCandyL"),1);
			recipe1.SetResult(mod.ItemType("UrshifuRapidStrikeStyleBall"));
