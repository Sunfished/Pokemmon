...
namespace Pokemmon.Items.Pokemon
{
	...
	public class SteeneeBall : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.shoot = mod.ProjectileType("Steenee");
			item.shootSpeed = 10f;
			item.buffType = mod.BuffType("BuffSteenee"); //The buff added to player after used the item
		...
		public override void AddRecipes()
		{
			...
			recipe0.SetResult(mod.ItemType("TsareenaBall"));
			...
			recipe99.SetResult(mod.ItemType("BounsweetBall"));
